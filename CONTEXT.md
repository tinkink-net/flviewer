...
| **Lazy chunk**              | The separately-emitted pdf.js bundle (engine + inlined worker source), downloaded via dynamic import on first PDF preview. Image previews never download it.                                                          |
